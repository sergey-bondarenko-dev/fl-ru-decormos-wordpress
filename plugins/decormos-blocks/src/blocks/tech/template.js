...
const FLOOR_LIST = [
	'2-3 слоя лака/мастики/пропитки',
	'2 слоя грунта',
	'1-2 слоя микроцемента',
	'2 слоя микробетона (может быть финишным покрытием)',
	'Основание: бетон / полусухая стяжка / стяжка / наливной пол / плитка',
];

const WALL_CAPTION = 'Схема нанесения слоев на стены';
const WALL_LIST = [
	'Основание: ЦСП / плитка / гипсовая и цементная штукатурка и шпаклевки / гипсокартон / ГВЛ / СМЛ / бетон / фанера / ОСП',
	'1-2 слоя акрилового грунта',
	'1-2 слоя микробетона (может быть финишным покрытием)',
	'1-2 слоя микроцемента (в зависимости от желаемого результата)',
	'Пропитка полуматовая или другие матовые / глянцевые лаки',
];
			...
			<figure className="tech__figure">
				...
				>
					...
					<g className="labels" transform="translate(0 15)">
						<text x="20" y="38" className="label">2-3 слоя лака/мастики/пропитки</text>
						<text x="20" y="78" className="label">2 слоя грунта</text>
						<text x="20" y="118" className="label">1-2 слоя микроцемента</text>
						...
						<text x="20" y="222" className="label">1-2 слоя акрилового грунта</text>
						<text x="20" y="262" className="label">Основание: бетон / полусухая стяжка</text>
						<text x="20" y="284" className="label"> / стяжка / наливной пол / плитка</text>
					</g>
				</svg>
			...
			<figure className="tech__figure">
				...
				>
					...
					<g className="labels" transform="translate(1150 60)">
						...
						<text x="0" y="60" className="label">шпаклевки / гипсокартон / ГВЛ / СМЛ / бетон / фанера / ОСП</text>
						<text x="0" y="120" className="label">1-2 слоя акрилового грунта</text>
						...
						<text x="0" y="300" className="label">Пропитка полуматовая или другие матовые / глянцевые лаки</text>
					</g>
				</svg>
